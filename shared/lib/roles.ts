 ...
 *  Always renders in Asia/Manila explicitly — never rely on the runtime's
 *  ambient local timezone, since that's UTC on Railway and something else in
 *  dev, and the two silently disagree. */
